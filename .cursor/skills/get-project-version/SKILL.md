...
description: Resolve a versão atual do controle de faturas a partir de version.json e da branch Git. Usar ao criar branch, card Jira, bump de versão, subir deploy (tag) ou expor a versão na API/front.
---
